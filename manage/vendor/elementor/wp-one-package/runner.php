...
if ( preg_match( $pattern, __DIR__, $matches ) ) {
	$wp_one_package_versions[ $matches[1] ] = '1.0.58';
}

if ( ! function_exists( 'elementor_one_register_1_dot_0_dot_58' ) && function_exists( 'add_action' ) ) {
	...
	add_action( 'plugins_loaded', 'elementor_one_register_1_dot_0_dot_58', -20, 0 );

	function elementor_one_register_1_dot_0_dot_58() {
		$versions = \ElementorOne\Versions::instance();
		$versions->register( '1.0.58', 'elementor_one_initialize_1_dot_0_dot_58' );
	}

	function elementor_one_initialize_1_dot_0_dot_58() {
